...
\ 'do': 'yarn install',
\ 'for': ['javascript', 'typescript', 'css', 'vue',
...
" au FileType vue nmap <Leader>py :!prettier-standard %<enter>
...
" autocmd BufWritePre *.js,*.jsx,*.mjs,*.ts,*.tsx,*.css,*.less,*.scss,*.json,*.graphql,*.md PrettierAsync
" autocmd BufWritePre *.mjs,*.tsx,*.css,*.less,*.scss,*.json,*.graphql,*.md PrettierAsync
" " }}}
" ctrlp ------------------------ {{{
" +++ CtrlP +++
...
nnoremap <localLeader>ts :set filetype=typescript<cr>
" }}}
...
let g:LanguageClient_serverCommands = {
    \ 'javascript': ['/Users/bantana/.config/yarn/global/node_modules/javascript-typescript-langserver/lib/language-server-stdio.js'],
    \ 'vue': ['vls'],
    \ }
...
nnoremap <silent> <leader>t :call LanguageClient_textDocument_rename()<CR>
" }}}
" function! PrettierStandard()
"   silent !clear
"   " execute "!" . g:potion_command . " " . bufname("%")
"   execute "!" . "prettier-standard" . " " . bufname("%")
" endfunc

nnoremap <leader>py :!prettier-standard %<CR>
